...
Xây personal portfolio dạng single-page scroll-narrative cho Mai Tan Thep (brand "thepKz", domain minthep.com, Ha Noi), định vị full-stack product builder — người tự design/build/ship sản phẩm thật từ đầu đến cuối, với chapter Korean Bridge Engineer là differentiator (không phải headline). Art direction = "Deep Signal": scroll dọc xuống một abyssal-blue void, ONE signature 3D object (iridescent wireframe accretion form, nod tới project "Black Hole Magic") là nguồn phát signal duy nhất, mỗi section emerge từ bóng tối như một incoming transmission. KHÔNG header/footer truyền thống — navigation là scroll narrative + floating side progress indicator + Cmd/Ctrl-K command palette (mobile = floating dot/FAB). Tech: Next.js 15 (App Router + Turbopack), TypeScript, GSAP (ScrollTrigger + SplitText), Swiper.js, jQuery compat layer, TailwindCSS, và three / @react-three/fiber / @react-three/drei (lazy, SSR-safe, chỉ cho ONE hero moment) — deploy Vercel. Media thật chưa có → dùng picsum.photos + Unsplash bọc trong một "Deep Signal duotone" treatment để swap real assets sau này = đổi src only. 