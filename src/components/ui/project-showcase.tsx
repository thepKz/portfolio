...
const projectAccents = [
  { color: "rgba(139,92,246,1)",  glow: "rgba(139,92,246,0.35)",  bar: "#8b5cf6", border: "rgba(139,92,246,0.25)",  bg: "rgba(139,92,246,0.07)"  },
  { color: "rgba(249,115,22,1)",  glow: "rgba(249,115,22,0.32)",  bar: "#f97316", border: "rgba(249,115,22,0.22)",  bg: "rgba(249,115,22,0.06)"  },
  { color: "rgba(6,182,212,1)",   glow: "rgba(6,182,212,0.3)",    bar: "#06b6d4", border: "rgba(6,182,212,0.2)",    bg: "rgba(6,182,212,0.06)"   },
  { color: "rgba(251,191,36,1)",  glow: "rgba(251,191,36,0.28)",  bar: "#fbbf24", border: "rgba(251,191,36,0.18)",  bg: "rgba(251,191,36,0.06)"  },
  { color: "rgba(52,211,153,1)",  glow: "rgba(52,211,153,0.28)",  bar: "#34d399", border: "rgba(52,211,153,0.18)",  bg: "rgba(52,211,153,0.06)"  },
]
      ...
      <div className="relative z-10 mx-auto max-w-[1400px]">
        ...
        >
          ...
          <p className="text-sm font-mono uppercase tracking-[0.18em] text-white/25">
            /// DEPLOYMENT LOG &middot; SELECT ENTRY TO OPEN
          </p>
        </motion.div>
